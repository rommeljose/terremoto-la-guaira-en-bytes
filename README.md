...
| `lamina_matriz_estaciones.png` | recorte del panel superior de `Norma_Emergencia/trabajo/03_salidas/lamina_redes_paper3.png` (ventanas occidental y oriental apiladas, sin título ni recuentos) | §16 · una matriz de estaciones geofísicas a lo largo del litoral: así se entiende el subsuelo |
